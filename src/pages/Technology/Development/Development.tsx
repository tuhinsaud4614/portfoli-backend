...
const Platform: React.FC<PlatformAndTechniqueProps> = ({ technologyType }) => {
  ...
  const { error, typeError, platforms, isAdding, isFetching } = useSelector<AppState>(
  ...
  const deleteHandler = (id: string): void => {
    dispatch(deletePlatform(id, technologyType));
  };
...
const Technique: React.FC<PlatformAndTechniqueProps> = ({ technologyType }) => {
  ...
  const { error,typeError, techniques, isAdding, isFetching } = useSelector<AppState>(
  ...
  const deleteHandler = (id: string): void => {
    dispatch(deleteTechnique(id, technologyType));
  };
